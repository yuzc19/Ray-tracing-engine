...
Vector3f minV(const Vector3f& v0, const Vector3f& v1) {
  return Vector3f(std::min(v0.x(), v1.x()), std::min(v0.y(), v1.y()),
                  std::min(v0.z(), v1.z()));
}

Vector3f maxV(const Vector3f& v0, const Vector3f& v1) {
  return Vector3f(std::max(v0.x(), v1.x()), std::max(v0.y(), v1.y()),
                  std::max(v0.z(), v1.z()));
}

float maxNorm(const Vector3f& v) {
